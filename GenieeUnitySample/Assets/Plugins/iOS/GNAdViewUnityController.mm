         ...
         logPriority:(int)intLogPriority
{
    ...
    _adView = [[GNAdView alloc] initWithFrame:CGRectMake(0, 0, adSize.width, adSize.height) adSizeType:adSizeType appID:adMobID];
    ...
    // Add Ad Base View
    adViewController.view = [[GNAdTransparentView alloc] init];
